 ...
 */
public class SubAreaSpinnerAdapter extends ArrayAdapter<String> {


    Activity activity;
    List<SubAreaPojo> pojoList;



    SubAreaSpinnerAdapter(Activity activity, List<SubAreaPojo> pojoList)
    {
        super(activity,-1);
    ...
    public SubAreaPojo getPojo(int i)
    {
